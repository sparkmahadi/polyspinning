      ...
      <div className="relative">
        ...
        <div className="hero bg-base-200 text-left">
                <div className="hero-content flex-col lg:flex-row-reverse">
                    ...
                    <div>
                        <h1 className="text-xl md:text-2xl lg:text-3xl font-bold">Drawn Textured Yarn</h1>
                        ...
                        <div className='md:flex gap-5'>
                            <Link to={'present-lot-and-transfer-area'}>
                                <button className="btn btn-primary btn-sm">View Present Lot</button>
                            </Link>
                            <Link to={'dty-machines-from-present-lot'}><button className='btn btn-outline btn-sm'>All Machines With Present Lot</button></Link>
                        </div>
                    </div>
                </div>
            </div>
